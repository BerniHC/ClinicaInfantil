...
<form class="row" method="post" >
    ...
    <div class="col-md-6">
        <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
            ...
            {{ Form::text('description', $category->description, array('class' => 'form-control', 'maxlength' => '50')) }}
        ...
        <div class="form-group {{ $errors->has('color') ? 'has-error' : '' }}">
            ...
            <div class="input-group" data-role="colorpicker">
                {{ Form::text('color', $category->color, array('class' => 'form-control', 'data-mask' => '#******', 'placeholder' => '#FFFFFF')) }}
