...
<form class="row" method="post" >
    ...
    <div class="col-xs-12 col-md-6">                
        ...
        <div class="form-group {{ $errors->has('father') ? 'has-error' : '' }}">
            ...
            {{ Form::text('father', '', array('class' => 'form-control', 'maxlength' => '100')) }}
        ...
        <div class="form-group {{ $errors->has('mother') ? 'has-error' : '' }}">
            ...
            {{ Form::text('mother', '', array('class' => 'form-control', 'maxlength' => '100')) }}
        ...
        <div class="form-group {{ $errors->has('school') ? 'has-error' : '' }}">
            ...
            {{ Form::text('school', '', array('class' => 'form-control', 'maxlength' => '100')) }}
